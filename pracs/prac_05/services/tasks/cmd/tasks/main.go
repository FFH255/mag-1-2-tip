...
import (
	...
	tasksauth "prac_05/services/tasks/internal/client/authclient"
	taskshttp "prac_05/services/tasks/internal/http"
	"prac_05/services/tasks/internal/repository"
	"prac_05/services/tasks/internal/service"
	"prac_05/shared/logger"
	"prac_05/shared/metrics"
	"prac_05/shared/middleware"
)
