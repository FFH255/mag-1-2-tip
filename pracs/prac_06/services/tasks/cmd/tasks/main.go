...
import (
	...
	tasksauth "prac_06/services/tasks/internal/client/authclient"
	taskshttp "prac_06/services/tasks/internal/http"
	"prac_06/services/tasks/internal/repository"
	"prac_06/services/tasks/internal/service"
	"prac_06/shared/logger"
	"prac_06/shared/metrics"
	"prac_06/shared/middleware"
)
