...
import (
	...
	tasksauth "prac_08/services/tasks/internal/client/authclient"
	taskshttp "prac_08/services/tasks/internal/http"
	"prac_08/services/tasks/internal/repository"
	"prac_08/services/tasks/internal/service"
	"prac_08/shared/logger"
	"prac_08/shared/metrics"
	"prac_08/shared/middleware"
)
