...
import (
	...
	"prac_10/services/tasks/internal/cache"
	tasksauth "prac_10/services/tasks/internal/client/authclient"
	taskshttp "prac_10/services/tasks/internal/http"
	"prac_10/services/tasks/internal/repository"
	"prac_10/services/tasks/internal/service"
	"prac_10/shared/logger"
	"prac_10/shared/metrics"
	"prac_10/shared/middleware"
)
