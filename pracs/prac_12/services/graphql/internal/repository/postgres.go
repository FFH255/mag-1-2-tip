...
import (
	...
	"prac_12/services/graphql/internal/service"
)

// PostgresRepository читает/пишет ту же таблицу tasks, что и REST-сервис tasks
// (см. services/tasks/migrations/001_tasks.sql). Это и есть "единый слой
// данных" из методички: GraphQL и REST работают с одним источником истины — БД.
...
// SearchByTitle — параметризованный запрос: внешний ввод идёт через $1 и
// никогда не склеивается со строкой SQL (защита от инъекций).
