...
import (
	...
	"prac_12/services/tasks/internal/cache"
	tasksauth "prac_12/services/tasks/internal/client/authclient"
	taskshttp "prac_12/services/tasks/internal/http"
	"prac_12/services/tasks/internal/repository"
	"prac_12/services/tasks/internal/service"
	"prac_12/shared/logger"
	"prac_12/shared/metrics"
